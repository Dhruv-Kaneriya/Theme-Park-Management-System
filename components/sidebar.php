...
<div class="md:h-screen overflow-hidden flex items-center justify-center">
    <div class="md:flex flex-col md:flex-row md:min-h-screen w-full">
      <div
        ...
        class="flex flex-col w-full md:w-64 text-gray-700 bg-green-800 dark-mode:text-gray-200 dark-mode:bg-gray-800 flex-shrink-0"
        x-data="{ open: false }"
      >
        <div
        ...
        >
          ...
          >
            <button
              @click="open = !open"
              class="flex flex-row items-center text-white w-full px-4 py-2 mt-2 text-sm font-semibold text-left bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:focus:bg-gray-600 dark-mode:hover:bg-gray-600 md:block hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
